...
function ResendButton({ onResend, loading }: { onResend: () => void; loading: boolean }) {
  ...
  if (countdown > 0) {
    return (
      <p className='font-body text-xs text-cream/30 text-center'>
        Resend in <span className='text-cream/50 tabular-nums'>{countdown}s</span>
      </p>
    )
  }
        ...
        {step === 'email' && (
          ...
          >
            <div className='bg-shadow/50 backdrop-blur-xl border border-gold/10 rounded-[2rem] p-8 sm:p-10 shadow-card'>
              <div className='mb-8'>
                <div className='inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-gold/20 bg-gold/5 mb-5'>
                  <span className='w-1.5 h-1.5 rounded-full bg-gold animate-pulse-slow' />
                  <span className='font-body text-[11px] text-gold/70 tracking-wide'>
                    Join 4,200+ creators
                  </span>
                </div>
              ...
              <p className='font-body text-xs text-cream/25 text-center mt-5 leading-relaxed px-2'>
                By creating an account you agree to our{' '}
                <Link href='/terms' className='text-cream/40 hover:text-gold transition-colors'>Terms</Link>
                {' '}and{' '}
                <Link href='/privacy' className='text-cream/40 hover:text-gold transition-colors'>Privacy Policy</Link>
              </p>

              <p className='font-body text-sm text-cream/35 text-center mt-5'>
                Already have an account?{' '}
                <Link href='/login' className='text-gold hover:text-gold-200 transition-colors'>
                  Sign in
                </Link>
              </p>
            </div>
        ...
        {step === 'otp' && (
          ...
          >
            <div className='bg-shadow/50 backdrop-blur-xl border border-gold/10 rounded-[2rem] p-8 sm:p-10 shadow-card'>
              ...
              <ResendButton onResend={() => sendOTP(email)} loading={sending} />
